(function () {
  ...
  function routeUrl(path) {
    ...
    const clean = routeMap[file];
    if (clean) url.pathname = url.pathname.replace(/[^/]*$/, clean);
    ...
    const html = `
      <div class="container">
        <div class="row g-4 align-items-start">
          <div class="col-lg-4">
            <h2>Beauty Zara collection <span class="brand-dot">.</span></h2>
            <p>Affordable  fashion for  buyers and wholesale customers.</p>
            <div class="social-icons mt-3">
              <a href="https://instagram.com" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
              <a href="https://tiktok.com" aria-label="TikTok"><i class="fa-brands fa-tiktok"></i></a>
              <a href="https://facebook.com" aria-label="Facebook"><i class="fa-brands fa-facebook-f"></i></a>
              <a href="https://wa.me/${ADMIN_WHATSAPP_NUMBER}" aria-label="WhatsApp"><i class="fa-brands fa-whatsapp"></i></a>
            </div>
          </div>
  ...
  function initRouteState() {
    ...
    const clean = routeMap[normalizedRoute];
    if (clean && location.protocol !== "file:") {
      const nextPath = location.pathname.replace(/[^/]*$/, clean);
